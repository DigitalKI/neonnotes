...
func _enter_tree() -> void:
	# The bridge is intentionally editor-only. It remains usable without an
	# active Play/debug session; game-dependent tools return a clear error until
	# the user starts the project.
